...
public class BookService {
    ...
    public BookList findBookByCondition(Filter filter, Pageable pageable) {
        ...
        bookList.setBookList(booksRepository.findBookByCondition(filter.getTacgia(), filter.getGiathap(),
                filter.getGiacao(), filter.getNamsb(), filter.getLoai(), pageable));
        bookList.setCount(booksRepository.findBookByCondition(filter.getTacgia(), filter.getGiathap(),
                filter.getGiacao(), filter.getNamsb(), filter.getLoai()));
        return bookList;
    }
